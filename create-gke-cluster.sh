...
kubectl apply -f google-cloud-kubernetes/00-mongodb.yaml
...
kubectl apply -f google-cloud-kubernetes/01-mongo-express.yaml

# Start zookeeper for management of Kafka nodes
kubectl apply -f google-cloud-kubernetes/02-zookeeper.yaml
...
kubectl apply -f google-cloud-kubernetes/03-kafka.yaml
...
kubectl apply -f google-cloud-kubernetes/04-spark.yaml
...
kubectl apply -f google-cloud-kubernetes/05-webapp.yaml